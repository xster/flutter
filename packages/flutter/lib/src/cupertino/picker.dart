...
/// or pop-up menu. In that case, you might pair the [SelectionWheelScrollView]
/// with a [ListBody] child.
///
/// When you have a list of children and do not require cross-axis
/// shrink-wrapping behavior, for example a scrolling list that is always the
/// width of the screen, consider [ListView], which is vastly more efficient
/// that a [SelectionWheelScrollView] containing a [ListBody] or [Column] with
/// many children.
///
/// See also:
///
...
class SelectionWheelScrollView extends StatelessWidget {
  /// Creates a box in which a single widget can be scrolled.
  SelectionWheelScrollView({
    Key key,
        ...
        new Center(
          child: new Scrollable(
            ...
            viewportBuilder: (BuildContext context, ViewportOffset offset) {
              return new _SelectionWheelViewport(
                axisDirection: axisDirection,
...
class _SelectionWheelViewport extends SingleChildRenderObjectWidget {
  const _SelectionWheelViewport({
    Key key,
  ...
  @override
  _RenderSelectionWheelViewport createRenderObject(BuildContext context) {
    return new _RenderSelectionWheelViewport(
      itemExtent: itemExtent,
      offset: offset,
    );
  }
  ...
  @override
  void updateRenderObject(BuildContext context, _RenderSelectionWheelViewport renderObject) {
    renderObject
      ..itemExtent = itemExtent
      ..offset = offset;
  }
...
class _RenderSelectionWheelViewport
    extends RenderBox
    with RenderObjectWithChildMixin<RenderBox>
    implements RenderAbstractViewport {
  _RenderSelectionWheelViewport({
  ...
  double get _minScrollExtent {
    assert(hasSize);
    // return 0.0;
    return - size.height / 2.0 + _itemExtent;
  }
  ...
  double get _maxScrollExtent {
    ...
    return math.max(0.0, child.size.height - size.height / 2.0);
  }
